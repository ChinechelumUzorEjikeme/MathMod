...
subtitle: "Модель боевых действий - вариант 24"
...
В начальный момент времени страна $X$ имеет армию численностью 400000 человек, 
а в распоряжении страны $Y$ армия численностью в 100000 человек.
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.31x(t) - 0.76y(t) + sin(3t)
	\\   
	\frac{dy}{dt}= -0.8x(t) - 0.21y(t) + cos(4t)+2
 \end{cases}
$$
...
$$
 \begin{cases}
	\frac{dx}{dt}= -0.21(t) - 0.7y(t) + sin(10t)
	\\   
	\frac{dy}{dt}= -0.56x(t)y(t) - 0.15y(t) + cos(10t)
 \end{cases}
$$
